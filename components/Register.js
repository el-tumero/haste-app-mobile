...
export default function Register() {
  ...
  const handleInterestPick = (interest) => {
    ...
    if (interestsArr.includes(interest)) {
      console.log("includes alr");
      return;
    }
    setInterestsArr((currentInterests) => [...currentInterests, interest]);
    console.log(interestsArr);
    ...
    return (
      <SafeAreaView style={styles.main}>
        ...
        <Card title="Jak Ci na imię?">
          ...
          <Text style={styles.regText}>Wybrana data: {shortDate}</Text>
